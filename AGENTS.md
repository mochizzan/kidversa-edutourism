...
(3246 node, 13832 edge) dan codegraph pada branch v1.8.
...
Layered backend (diverifikasi via MCP):
  ...
  migrations/           -> golang-migrate SQL: SATU file terkonsolidasi
                          000001_init_schema.up.sql
                          (catatan: versi AGENTS.md lama menyebut 000001-000012, SUDAH TIDAK BENAR)
...
## Where to Look
  ...
  Tambah tabel/query         -> backend/internal/infrastructure/persistence/ + migrations/000001_init_schema.up.sql
...
## Catatan Perubahan vs Versi AGENTS.md Sebelumnya (yang terhapus)
  - DIPERBAIKI: jumlah migrasi -> sekarang hanya 000001_init_schema (terkonsolidasi),
    bukan 000001-000012.
